/**
 * Pokemon name dictionary for search autocomplete and spell-check suggestions.
 * Covers all generations through Gen 9 + common forms and variants.
 */
...
export const POKEMON_NAMES: string[] = [
  ...
  "Eelektross","Elgyem","Beheeyem","Litwick","Lampent","Chandelure","Axew","Fraxure","Haxorus","Cubchoo",
  "Beartic","Cryogonal","Shelmet","Accelgor","Stunfisk","Mienfoo","Mienshao","Druddigon","Golett","Golurk",
  "Pawniard","Bisharp","Bouffalant","Rufflet","Braviary","Vullaby","Mandibuzz","Heatmor","Durant","Deino",
  ...
  "Flabébé","Floette","Florges","Skiddo","Gogoat","Pancham","Pangoro","Furfrou","Espurr","Meowstic",
  ...
  "Amaura","Aurorus","Sylveon","Hawlucha","Dedenne","Carbink","Goomy","Sliggoo","Goodra","Klefki",
  "Phantump","Trevenant","Pumpkaboo","Gourgeist","Bergmite","Avalugg","Noibat","Noivern","Xerneas","Yveltal",
  ...
  "Pyukumuku","Type: Null","Silvally","Minior","Komala","Turtonator","Togedemaru","Mimikyu","Bruxish",
  ...
  "Guzzlord","Necrozma","Magearna","Marshadow","Zeraora",
  // Gen 8
  ...
  "Charcadet","Armarouge","Ceruledge","Tadbulb","Bellibolt","Wattrel","Kilowattrel","Maschiff","Mabosstiff",
  "Shroodle","Grafaiai","Bramblin","Brambleghast","Toedscool","Toedscruel","Klawf","Capsakid","Scovillain",
  "Rellor","Rabasca","Flittle","Espathra","Tinkatink","Tinkatuff","Tinkaton","Wiglett","Wugtrio","Bombirdier",
  "Finizen","Palafin","Varoom","Revavroom","Cyclizar","Orthworm","Glimmet","Glimmora","Greavard","Houndstone",
  "Flamigo","Cetoddle","Cetitan","Veluza","Dondozo","Tatsugiri","Annihilape","Clodsire","Farigiraf","Dudunsparce",
  "Kingambit","Great Tusk","Scream Tail","Brute Bonnet","Flutter Mane","Slither Wing","Sandy Shocks","Iron Treads",
  ...
  "Koraidon","Miraidon","Walking Wake","Iron Leaves","Dipplin","Poltchageist","Sinistcha","Okidogi","Munkidori",
  "Fezandipiti","Ogerpon","Archaludon","Hydrapple","Gouging Fire","Raging Bolt","Iron Crown","Terapagos",
  // Common forms/variants users search for
  "Charizard ex","Pikachu ex","Mewtwo ex","Mew ex","Umbreon ex","Espeon ex","Greninja ex","Rayquaza ex",
  "Lugia ex","Ho-Oh ex","Groudon ex","Kyogre ex","Dialga ex","Palkia ex","Arceus ex","Darkrai ex",
  "Giratina ex","Reshiram ex","Zekrom ex","Kyurem ex","Xerneas ex","Yveltal ex","Zygarde ex","Solgaleo ex",
  "Lunala ex","Necrozma ex","Zacian ex","Zamazenta ex","Eternatus ex","Calyrex ex","Koraidon ex","Miraidon ex",
  "Pikachu V","Pikachu VMAX","Pikachu VSTAR","Charizard V","Charizard VMAX","Charizard VSTAR","Mew V","Mew VMAX",
  "Umbreon V","Umbreon VMAX","Rayquaza V","Rayquaza VMAX","Lugia V","Lugia VSTAR","Giratina V","Giratina VSTAR",
  "Dialga V","Dialga VSTAR","Palkia V","Palkia VSTAR","Arceus V","Arceus VSTAR","Darkrai V","Darkrai VSTAR",
];

/**
 * Get autocomplete suggestions for a partial query.
 * Uses Fuse.js for fuzzy matching on the pokemon name list.
 */
export function getPokemonSuggestions(query: string, limit: number = 5): string[] {
  if (!query || query.trim().length < 1) return [];
  const fuse = new (require('fuse.js'))(POKEMON_NAMES, {
    threshold: 0.3,
    distance: 50,
    ignoreLocation: true,
  });
  return fuse.search(query.trim()).slice(0, limit).map((r: any) => r.item);
}
